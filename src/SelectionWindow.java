				...
				for (String chemicalOption : attackOptions) {
					...
					itemOption.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							BattleWindow bw = new BattleWindow(playerOne, playerTwo, chemicalOption, playerOne.isTurn(),
									AttackOptions.getStartChemical(chemicalOption));
							bw.setVisible(true);
							SelectionWindow.this.dispose();
						}
					});
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (String chemicalOption : defendOptions) {
					...
					itemOption.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							BattleWindow bw = new BattleWindow(playerOne, playerTwo, chemicalOption, playerOne.isTurn(),
									DefenseOptions.getStartingChemical(chemicalOption));
							bw.setVisible(true);
							SelectionWindow.this.dispose();
						}
					});
